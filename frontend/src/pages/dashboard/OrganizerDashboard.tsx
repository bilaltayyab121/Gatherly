    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const eventsResponse = await fetch(
          "https://gatherly-backend.vercel.app/api/v1/organizer/events",
          {
            headers: {
        ...
        const statsResponse = await fetch(
          "https://gatherly-backend.vercel.app/api/v1/organizer/stats",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleDeleteEvent = async (eventId: string) => {
    ...
    try {
      const response = await fetch(
        `https://gatherly-backend.vercel.app/api/v1/events/${eventId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
